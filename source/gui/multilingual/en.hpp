...
#ifndef ZL_INTERFACE_MULTILINGUAL_EN_HPP
#define ZL_INTERFACE_MULTILINGUAL_EN_HPP

#include <array>

namespace zlInterface::multilingual::en {
...
#endif //ZL_INTERFACE_MULTILINGUAL_EN_HPP
