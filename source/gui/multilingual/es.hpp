...
#ifndef ZL_INTERFACE_MULTILINGUAL_ES_HPP
#define ZL_INTERFACE_MULTILINGUAL_ES_HPP

#include <array>

namespace zlInterface::multilingual::es {
...
#endif //ZL_INTERFACE_MULTILINGUAL_ES_HPP
