...
namespace zlpanel::multilingual::it {
    static constexpr std::array kTexts = {
        ...
        "Filtro a Fase Minima con correzioni aggiuntive. Filtro a Fase Lineare con risposta in ampiezza analoga al prototipo analogico. NON adatto per la modulazione.",
