...
namespace zlpanel {
    MatchControlPanel::MatchControlPanel(PluginProcessor& p,
        ...
        save_button_(base, save_drawable_.get(), nullptr,
                     tooltip_helper.getToolTipText(multilingual::kMatchSave)),
        target_box_({"Side", "Flat", "Preset"}, base,
                    tooltip_helper.getToolTipText(multilingual::kMatchTarget)),
        label_laf_(base),
        shift_label_("", "Shift"),
        shift_slider_("", base),
        smooth_label_("", "Smooth"),
        smooth_slider_("", base,
                       tooltip_helper.getToolTipText(multilingual::kMatchSmooth)),
        slope_label_("", "Slope"),
        slope_slider_("", base,
                      tooltip_helper.getToolTipText(multilingual::kMatchSlope)),
